...
--
-- Host: 127.0.0.1    Database: BrainTrain
-- ------------------------------------------------------
...
CREATE TABLE `Border` (
  ...
  `BorderName` varchar(45) NOT NULL,
...
INSERT INTO `Border` VALUES (1,'small',3),(2,'normal',4),(3,'large',5);
...
-- Dump completed on 2016-08-25 11:37:17
